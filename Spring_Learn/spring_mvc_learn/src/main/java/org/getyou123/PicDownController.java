...
@Controller
public class PicDownController {
    /**
     * 实现文件下载
     * @param session se
     * @return byte[]
    ...
    public ResponseEntity<byte[]> testResponseEntity(HttpSession session) throws IOException {
        ...
        String realPath = servletContext.getRealPath("/static/img/1.jpeg"); //创建输入流
        ...
        headers.add("Content-Disposition", "attachment;filename=1.jpeg"); //设置响应状态码
