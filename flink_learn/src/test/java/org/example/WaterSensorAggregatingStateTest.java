...
import org.example.flink_training.StateLearn.WaterSensorAggregatingStateLearn;
import org.example.flink_training.pojo.WaterSensor;
import org.junit.Test;

public class WaterSensorAggregatingStateTest {
    @Test
    public void WaterSensorListStateTest001() {
        try {
            ...
            stream.keyBy(WaterSensor::getId)
                    .process(new WaterSensorAggregatingStateLearn())
                    .print("计算平均值");
