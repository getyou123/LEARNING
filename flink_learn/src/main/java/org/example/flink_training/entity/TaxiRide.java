package org.example.flink_training.entity;
...
public class TaxiRide implements Comparable<TaxiRide>, Serializable {
    ...
    public boolean isStart; // 行程开始事件为 TRUE， 行程结束事件为 FALSE
    public Instant eventTime; // 事件的时间戳
    public float startLon;   // 车程开始位置的经度
    public float startLat;  // 车程开始位置的维度
    public float endLon; // 车程结束位置的经度
    public float endLat; // 车程结束位置的维度
    public short passengerCnt;  // 乘车人数
