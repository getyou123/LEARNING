...
public class App {
    ...
    public static String index_path= "/Users/haoguowang/indexDir";
    ...
    public void testCreate() throws Exception{
        ...
        //2 索引目录类,指定索引在硬盘中的位置
        Directory directory = FSDirectory.open(new File(App.index_path));
    ...
    public void testCreate2() throws Exception{
        ...
        document5.add(new TextField("title1", "谷歌地图之父拉斯加盟社交网站Facebook", Field.Store.YES));
        docs.add(document5);
